...
class ChatPage extends StatefulWidget {
  const ChatPage({super.key, required this.channel, required this.user});
...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> markAsRead() async {
    await channelDocumentRef.set({"adminMessages": 0}, SetOptions(merge: true));
  }
          ...
          if (snapshot.hasData) {
            ...
            return ListView.separated(
              itemBuilder: (context, index) {
                ...
                return ListTile(
                    leading: message.senderID == Globals.currentAdmin!.uid
                        ? null
                        : SizedBox(
                            width: 40,
                            height: 40,
                    ...
                    trailing: message.senderID == Globals.currentAdmin!.uid
                        ? SizedBox(
                            width: 40,
                            height: 40,
                            child: CachedNetworkImage(
                              imageUrl: Globals.currentAdmin!.categoryInfo
                                  .getPhotoUrl(),
                              imageBuilder: ((context, imageProvider) =>
                                  CircleAvatar(
                                    backgroundImage: imageProvider,
                    ...
                    subtitle: message.senderID == Globals.currentAdmin!.uid
                        ? Text(
  ...
  Future<void> onSendMessage(String content) async {
    ...
    try {
      Map<String, dynamic> messageData = {
        ...
        "senderID": Globals.currentAdmin!.uid,
      };
      ...
      if (isFirst) {
        ...
        // shows.remove(Globals.currentAdmin!.uid);
        ...
        //         (channel.isGroup
        //             ? channel.groupName
        //             : Globals.currentAdmin!.firstName +
        //                 " " +
        //                 Globals.currentAdmin!.lastName),
        //     true);
      }
    } catch (e) {
      print(e);
